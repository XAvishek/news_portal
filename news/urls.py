...
urlpatterns = [
    ...
    path('<str:category>/<int:pk>/<str:slug>/', views.NewsDetailView.as_view(), name='news_detail'),
    ...
    path('<str:category>/<int:pk>/<str:slug>/comment/', views.create_comment, name='create_news'),
]
